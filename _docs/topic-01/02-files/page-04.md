...
**Scripts** add functionality to websites run on the client (your browser) or the server (think Amazon's computer).  Scripts are what makes sites interesting and dynamic.
